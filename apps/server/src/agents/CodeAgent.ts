...
const CODE_AGENT_CONFIG: AgentConfig = {
  slug: 'code-agent',
  name: 'CodeAgent',
...
export class CodeAgent extends BaseAgent {
  ...
  async execute(input: unknown): Promise<unknown> {
    const { designId, options } = input as {
      designId: string;
      options?: {
        language?: string;
        framework?: string;
    ...
    return await this.generateCode(designId, options);
  }
...
/**
 * Generate code from design
 * @deprecated Use codeAgent.generateCode() instead
 */
export async function generateCode(
  ...
  return await codeAgent.generateCode(designId, options);
}

/**
 * Review code for quality and security
 * @deprecated Use codeAgent.reviewCode() instead
 */
export async function reviewCode(
  ...
  return await codeAgent.reviewCode(codeAssetId, options);
}

/**
 * Refactor code
 * @deprecated Use codeAgent.refactorCode() instead
 */
export async function refactorCode(
  ...
  return await codeAgent.refactorCode(codeAssetId, goals);
}
